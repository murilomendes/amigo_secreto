...
RSpec.describe CampaignsController, type: :controller do
  ...
  describe "GET #show" do
    ...
    context "campaign doesn`t exists" do
  ...
  describe "POST #create" do 
    ...
    it "redirects to a new campaign" do 
  ...
  describe "PUT #update" do
    ...
    context "User is the campaign owner" do
      ...
      it "Campaign have new attributes" do 
  ...
  describe "GET #raffle" do 
    ...
    context "User is the campaign owner" do 
      ...
      context "hasn`t two members or more" do 
        before(:each) do 
          create(:member, campaign: @campaign)
          post :raffle, params: {id: campaign.id}
        end
    ...
    context "user isn`t the campaing owner" do 
      before(:each) do 
        @campaign = create(:campaign)
        post :raffle, params: {id: campaign.id}
      end
